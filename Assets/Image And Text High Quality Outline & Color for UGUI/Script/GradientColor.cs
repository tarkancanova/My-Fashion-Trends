...
{
    //Gradient Color for UGUI Text and Image 
    [AddComponentMenu("UI/Adamman/Gradient Color"), RequireComponent(typeof(Graphic))]
    public class GradientColor : BaseMeshEffect
    {
        private const int ONE_TEXT_VERTEX = 6; // one text vertex has 6 vertex

        [SerializeField]
        private Color m_colorTop = Color.white; // top color
        
        [SerializeField]
        private Color m_colorBottom = Color.white; // bottom color
        [SerializeField]
        private Color m_colorLeft = Color.white; // left color
        
        [SerializeField]
        private Color m_colorRight = Color.white; // right color
        [SerializeField, Range(-1f, 1f)]
        private float m_gradientOffsetVertical = 0f; // gradient offset vertical
        [SerializeField, Range(-1f, 1f)]
        private float m_gradientOffsetHorizontal = 0f; // gradient offset horizontal
        [SerializeField]
        private bool m_splitTextGradient = false; // split text gradient


        //publish function for other script
